...
const UpdateMenuCard = ({ id, ActiveCreate }) => {
  ...
  const handleUpdateMenu = async (event) => {
    ...
    if (availabilityElement.current.value === "not") {
      avail = false;
    }
    let item = {
    ...
    <div className="absolute bg-black w-full height-screen opacity-90 z-50 flex justify-center items-center">
      ...
      >
        ...
        <div class="mb-5">
          ...
          >
            Enter the Updated name of Food Item:
          </label>
          <input
            type="text"
            id="text"
        ...
        <div class="mb-5">
          ...
          >
            ...
            <option className="hover:bg-orange-300" value="available">
              Available
            </option>
            <option className="hover:bg-orange-300" value="not">
              Not Available
            </option>
          </select>
        </div>
